...
var useFormItemStatus = () => {
  const {
    ...
    errors = [],
    warnings = []
  } = (0, import_react.useContext)(FormItemInputContext);
  if (true) {
...
function useFrameState(defaultValue) {
  ...
  const batchRef = (0, import_react2.useRef)([]);
  const destroyRef = (0, import_react2.useRef)(false);
  React.useEffect(() => {
...
function useItemRef() {
  const {
    itemRef
  } = React2.useContext(FormContext);
  const cacheRef = React2.useRef({});
...
var Col = React3.forwardRef((props, ref) => {
  const {
    getPrefixCls,
    direction
  ...
  const {
    gutter,
    wrap
  } = React3.useContext(RowContext_default);
  const {
  ...
  return wrapCSSVar(React3.createElement("div", Object.assign({}, others, {
...
function useBreakpoint() {
  ...
  const screensRef = (0, import_react5.useRef)({});
...
function useMergedPropByScreen(oriProp, screen) {
  const [prop, setProp] = React6.useState(typeof oriProp === "string" ? oriProp : "");
...
var Row = React6.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    justify,
    align,
  ...
  const [screens, setScreens] = React6.useState({
    xs: true,
    sm: true,
    md: true,
    lg: true,
  ...
  const [curScreens, setCurScreens] = React6.useState({
    xs: false,
    sm: false,
    md: false,
    lg: false,
  ...
  const gutterRef = React6.useRef(gutter);
  const responsiveObserver = useResponsiveObserver();
  React6.useEffect(() => {
  ...
  const rowContext = React6.useMemo(() => ({
    gutter: [gutterH, gutterV],
    wrap
  }), [gutterH, gutterV, wrap]);
  return wrapCSSVar(React6.createElement(RowContext_default.Provider, {
    value: rowContext
...
function useDebounce(value) {
  const [cacheValue, setCacheValue] = React7.useState(value);
  React7.useEffect(() => {
...
var ErrorList = (_ref) => {
  ...
  const {
    prefixCls
  } = React8.useContext(FormItemPrefixContext);
  const baseClassName = `${prefixCls}-item-explain`;
  const rootCls = useCSSVarCls_default(prefixCls);
  const [wrapCSSVar, hashId, cssVarCls] = style_default(prefixCls, rootCls);
  const collapseMotion = (0, import_react6.useMemo)(() => motion_default(prefixCls), [prefixCls]);
  const debounceErrors = useDebounce(errors);
  const debounceWarnings = useDebounce(warnings);
  const fullKeyList = React8.useMemo(() => {
  ...
  return wrapCSSVar(React8.createElement(es_default, {
    ...
    return React8.createElement("div", Object.assign({}, helpProps, {
      className: (0, import_classnames3.default)(baseClassName, holderClassName, cssVarCls, rootCls, rootClassName, hashId),
      style: holderStyle,
      role: "alert"
    }), React8.createElement(CSSMotionList_default, Object.assign({
      keys: fullKeyList
...
var FormItemInput = (props) => {
  ...
  const formContext = React9.useContext(FormContext);
  const mergedWrapperCol = wrapperCol || formContext.wrapperCol || {};
  const className = (0, import_classnames4.default)(`${baseClassName}-control`, mergedWrapperCol.className);
  const subFormContext = React9.useMemo(() => Object.assign({}, formContext), [formContext]);
  delete subFormContext.labelCol;
  delete subFormContext.wrapperCol;
  const inputDom = React9.createElement("div", {
    className: `${baseClassName}-control-input`
  }, React9.createElement("div", {
    className: `${baseClassName}-control-input-content`
  }, children));
  const formItemContext = React9.useMemo(() => ({
    prefixCls,
    status
  }), [prefixCls, status]);
  const errorListDom = marginBottom !== null || errors.length || warnings.length ? React9.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "nowrap"
    }
  }, React9.createElement(FormItemPrefixContext.Provider, {
    value: formItemContext
  }, React9.createElement(ErrorList_default, {
    fieldId,
    errors,
    warnings,
    help,
  ...
  })), !!marginBottom && React9.createElement("div", {
    style: {
      width: 0,
      height: marginBottom
    }
  ...
  const extraDom = extra ? React9.createElement("div", Object.assign({}, extraProps, {
  ...
  const dom = formItemRender && formItemRender.mark === "pro_table_render" && formItemRender.render ? formItemRender.render(props, {
    ...
    extra: extraDom
  }) : React9.createElement(React9.Fragment, null, inputDom, errorListDom, extraDom);
  return React9.createElement(FormContext.Provider, {
    value: subFormContext
  }, React9.createElement(col_default, Object.assign({}, mergedWrapperCol, {
    className
  }), dom), React9.createElement(fallbackCmp_default, {
    prefixCls
  }));
};
...
var OrderContext = React11.createContext(null);
...
function useDom(render, debug) {
  ...
  var appendedRef = React12.useRef(false);
  var queueCreate = React12.useContext(Context_default);
  var _React$useState3 = React12.useState(EMPTY_LIST2), _React$useState4 = _slicedToArray(_React$useState3, 2), queue = _React$useState4[0], setQueue = _React$useState4[1];
...
var Portal = React14.forwardRef(function(props, ref) {
  ...
  var _React$useState = React14.useState(open), _React$useState2 = _slicedToArray(_React$useState, 2), shouldRender = _React$useState2[0], setShouldRender = _React$useState2[1];
  ...
  var _React$useState3 = React14.useState(function() {
  ...
  if (ref) {
    reffedChildren = React14.cloneElement(children, {
      ref: mergedRef
    });
  }
...
var CollectionContext = React15.createContext(null);
function Collection(_ref) {
  ...
  return React15.createElement(CollectionContext.Provider, {
    value: onResize2
  }, children);
}
...
function SingleObserver(props, ref) {
  ...
  var onCollectionResize = React17.useContext(CollectionContext);
  var isRenderProps = typeof children === "function";
  var mergedChildren = isRenderProps ? children(elementRef) : children;
  var sizeRef = React17.useRef({
    width: -1,
    height: -1,
    offsetWidth: -1,
    offsetHeight: -1
  });
  var canRef = !isRenderProps && React17.isValidElement(mergedChildren) && supportRef(mergedChildren);
  ...
  var propsRef = React17.useRef(props);
  propsRef.current = props;
  var onInternalResize = React17.useCallback(function(target) {
  ...
  return React17.createElement(DomWrapper, {
    ref: wrapperRef
  }, canRef ? React17.cloneElement(mergedChildren, {
    ref: mergedRef
  }) : mergedChildren);
}
var RefSingleObserver = React17.forwardRef(SingleObserver);
if (true) {
...
function ResizeObserver2(props, ref) {
  ...
  return childNodes.map(function(child, index2) {
    ...
    return React18.createElement(SingleObserver_default, _extends({}, props, {
      key,
      ref: index2 === 0 ? ref : void 0
    }), child);
  });
}
var RefResizeObserver = React18.forwardRef(ResizeObserver2);
if (true) {
...
var useId_default = useOriginId ? (
  ...
  function useCompatId(id) {
    var _React$useState = React19.useState("ssr-id"), _React$useState2 = _slicedToArray(_React$useState, 2), innerId = _React$useState2[0], setInnerId = _React$useState2[1];
...
var PopupContent = React22.memo(function(_ref) {
...
// node_modules/@rc-component/trigger/es/Popup/index.js
var Popup2 = React23.forwardRef(function(props, ref) {
  ...
  return React23.createElement(Portal2, {
    ...
    mask,
    motion: maskMotion
  }), React23.createElement(es_default3, {
    onResize: onAlign,
    disabled: !open
...
var TriggerWrapper = React24.forwardRef(function(props, ref) {
...
var TriggerContext = React25.createContext(null);
...
function generateTrigger() {
  ...
  var Trigger = React29.forwardRef(function(props, ref) {
    ...
    var _React$useState13 = React29.useState([0, 0]), _React$useState14 = _slicedToArray(_React$useState13, 2), mousePos = _React$useState14[0], setMousePos = _React$useState14[1];
    ...
    return React29.createElement(React29.Fragment, null, React29.createElement(es_default3, {
      disabled: !mergedOpen,
      ref: setTargetRef,
...
var Tooltip = function Tooltip2(props, ref) {
  ...
  var triggerRef = (0, import_react7.useRef)(null);
  ...
  return React30.createElement(es_default4, _extends({
...
var Tooltip_default = (0, import_react7.forwardRef)(Tooltip);
...
var zIndexContext = import_react8.default.createContext(void 0);
if (true) {
...
function useZIndex(componentType, customZIndex) {
  const [, token] = useToken();
  const parentZIndex = import_react9.default.useContext(zindexContext_default);
...
var prepareComponentToken2 = (token) => Object.assign(Object.assign({
...
var PurePanel = (props) => {
  ...
  }), React34.createElement(Popup, Object.assign({}, props, {
    className: hashId,
    prefixCls,
...
var InternalTooltip = React35.forwardRef((props, ref) => {
  var _a, _b;
  const {
    prefixCls: customizePrefixCls,
    openClassName,
  ...
  const tooltipPlacements = React35.useMemo(() => {
    var _a2, _b2;
  ...
  const memoOverlay = React35.useMemo(() => {
    if (title === 0) {
      return title;
    }
    return overlay || title || "";
  }, [overlay, title]);
  const memoOverlayWrapper = React35.createElement(NoCompactStyle, null, typeof memoOverlay === "function" ? memoOverlay() : memoOverlay);
  const {
    getPopupContainer,
    placement = "top",
    mouseEnterDelay = 0.1,
  ...
  const child = React35.isValidElement(children) && !isFragment(children) ? children : React35.createElement("span", null, children);
  ...
  const content = React35.createElement(es_default5, Object.assign({}, otherProps, {
    zIndex,
    ...
    overlayInnerStyle: formattedOverlayInnerStyle,
    arrowContent: React35.createElement("span", {
  ...
  return wrapCSSVar(React35.createElement(zindexContext_default.Provider, {
    value: contextZIndex
  }, content));
});
...
function toTooltipProps(tooltip) {
  ...
  if (typeof tooltip === "object" && !React36.isValidElement(tooltip)) {
    return tooltip;
  }
  return {
    title: tooltip
...
var FormItemLabel = (_ref) => {
  ...
  const {
    ...
    labelWrap,
    colon: contextColon
  } = React36.useContext(FormContext);
  if (!label) {
    return null;
  }
  ...
  const labelColClassName = (0, import_classnames14.default)(labelClsBasic, mergedLabelAlign === "left" && `${labelClsBasic}-left`, mergedLabelCol.className, {
  ...
  if (tooltipProps) {
    const {
      icon = React36.createElement(QuestionCircleOutlined_default, null)
    } = tooltipProps, restTooltipProps = __rest5(tooltipProps, ["icon"]);
    const tooltipNode = React36.createElement(tooltip_default, Object.assign({}, restTooltipProps), React36.cloneElement(icon, {
    ...
    labelChildren = React36.createElement(React36.Fragment, null, labelChildren, tooltipNode);
  }
  ...
  if (isRenderMark) {
    ...
    labelChildren = React36.createElement(React36.Fragment, null, labelChildren, React36.createElement("span", {
  ...
  const labelClassName = (0, import_classnames14.default)({
    [`${prefixCls}-item-required`]: required,
    [`${prefixCls}-item-required-mark-optional`]: isOptionalMark || isRenderMark,
    [`${prefixCls}-item-no-colon`]: !computedColon
  });
  return React36.createElement(col_default, Object.assign({}, mergedLabelCol, {
    className: labelColClassName
  }), React36.createElement("label", {
    htmlFor,
...
function StatusProvider(_ref) {
  ...
  const {
    feedbackIcons
  } = React37.useContext(FormContext);
  ...
  const formItemStatusContext = React37.useMemo(() => {
    var _a;
    let feedbackIcon;
    if (hasFeedback) {
      ...
      feedbackIcon = customIconNode !== false && IconNode ? React37.createElement("span", {
        className: (0, import_classnames15.default)(`${itemPrefixCls}-feedback-icon`, `${itemPrefixCls}-feedback-icon-${mergedValidateStatus}`)
      }, customIconNode || React37.createElement(IconNode, null)) : null;
    }
    const context = {
      status: mergedValidateStatus || "",
      errors,
...
function ItemHolder(props) {
  const {
    ...
    onSubItemMetaChange,
    layout
  } = props, restProps = __rest6(props, ["prefixCls", "className", "rootClassName", "style", "help", "errors", "warnings", "validateStatus", "meta", "hasFeedback", "hidden", "children", "fieldId", "required", "isRequired", "onSubItemMetaChange", "layout"]);
  const itemPrefixCls = `${prefixCls}-item`;
  const {
    requiredMark,
    vertical: formVertical
  } = React38.useContext(FormContext);
  ...
  const [marginBottom, setMarginBottom] = React38.useState(null);
  useLayoutEffect_default(() => {
  ...
  return React38.createElement("div", {
    ...
    style,
    ref: itemRef
  }, React38.createElement(row_default, Object.assign({
    ...
    "wrapperCol",
    "validateDebounce"
  ])), React38.createElement(FormItemLabel_default, Object.assign({
    htmlFor: fieldId
  }, props, {
    requiredMark,
    ...
    prefixCls,
    vertical
  })), React38.createElement(FormItemInput_default, Object.assign({}, props, meta, {
    ...
    marginBottom,
    onErrorVisibleChanged
  }), React38.createElement(NoStyleItemContext.Provider, {
    value: onSubItemMetaChange
  }, React38.createElement(StatusProvider, {
    prefixCls,
    meta,
    errors: meta.errors,
  ...
  }, children)))), !!marginBottom && React38.createElement("div", {
...
var MemoInput = React39.memo((_ref) => {
  let {
    children
  } = _ref;
  return children;
...
function InternalFormItem(props) {
  ...
  const {
    name: formName
  } = React39.useContext(FormContext);
  const mergedChildren = useChildren(children);
  const isRenderProps = typeof mergedChildren === "function";
  const notifyParentMetaChange = React39.useContext(NoStyleItemContext);
  const {
    validateTrigger: contextValidateTrigger
  } = React39.useContext(FieldContext_default);
  ...
  const listContext = React39.useContext(ListContext_default);
  const fieldKeyPathRef = React39.useRef();
  ...
  const [mergedErrors, mergedWarnings] = React39.useMemo(() => {
  ...
  function renderLayout(baseChildren, fieldId, isRequired) {
    if (noStyle && !hidden) {
      return React39.createElement(StatusProvider, {
        prefixCls,
    ...
    return React39.createElement(ItemHolder, Object.assign({
      key: "row"
    }, props, {
      className: (0, import_classnames17.default)(className, cssVarCls, rootCls, hashId),
      prefixCls,
      fieldId,
      isRequired,
      errors: mergedErrors,
  ...
  return wrapCSSVar(React39.createElement(Field_default, Object.assign({}, props, {
    ...
    if (Array.isArray(mergedChildren) && hasName) {
    ...
    } else if (React39.isValidElement(mergedChildren)) {
      ...
      childNode = React39.createElement(MemoInput, {
...
//# sourceMappingURL=chunk-X6TJBRQE.js.map
